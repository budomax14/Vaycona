...
export default function CreateBrandKitDialog({ isOpen, onClose, onCreate }) {
  ...
  const t = MISC_STRINGS[language].createBrandKit;
    ...
    >
      <div className="space-y-3">
        <label className="block">
          <span className="mb-1 block text-xs font-medium text-gray-500">{t.brandName}</span>
          <input
            autoFocus
            type="text"
        ...
        <div>
          <span className="mb-1 block text-xs font-medium text-gray-500">{t.initialColorsOptional}</span>
        ...
        <div className="grid grid-cols-2 gap-2">
          <label className="block">
            <span className="mb-1 block text-xs font-medium text-gray-500">{t.headingFontOptional}</span>
          ...
          <label className="block">
            <span className="mb-1 block text-xs font-medium text-gray-500">{t.bodyFontOptional}</span>
        ...
        <label className="block">
          <span className="mb-1 block text-xs font-medium text-gray-500">{t.logoOptional}</span>
          <input
            ref={fileRef}
            type="file"
