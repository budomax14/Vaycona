...
export const PRICE_IDS = {
  pro: { monthly: "price_pro_monthly_REPLACE_ME", annual: "price_pro_annual_REPLACE_ME" },
  business: { monthly: "price_business_monthly_REPLACE_ME", annual: "price_business_annual_REPLACE_ME" },
};
